...
\begin{DoxyCompactList}\small\item\em P\+DM Processing buffer size (Contain 2ms of P\+DM Sample) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em P\+CM Processing buffer size (Contain 2ms of P\+DM Sample) \end{DoxyCompactList}\item 
